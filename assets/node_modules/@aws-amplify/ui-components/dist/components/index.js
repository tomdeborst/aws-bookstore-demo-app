...
const AmplifyEmailField = class extends HTMLElement {
    ...
    render() {
        return (h("amplify-form-field", { fieldId: this.fieldId, label: I18n.get(this.label), placeholder: I18n.get(this.placeholder), type: "email", name: "email", required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    }
};
...
const AmplifyUsernameField = class extends HTMLElement {
    ...
    render() {
        return (h("amplify-form-field", { name: "username", fieldId: this.fieldId, label: I18n.get(this.label), placeholder: I18n.get(this.placeholder), required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    }
};
...
const AmplifyEmailField$1 = /*@__PURE__*/proxyCustomElement(AmplifyEmailField, [0,"amplify-email-field",{"fieldId":[1,"field-id"],"label":[1],"placeholder":[1],"required":[4],"handleInputChange":[16],"value":[1],"inputProps":[16],"disabled":[4]}]);
...
const AmplifyInput$1 = /*@__PURE__*/proxyCustomElement(AmplifyInput, [0,"amplify-input",{"fieldId":[1,"field-id"],"description":[1],"type":[1],"handleInputChange":[16],"placeholder":[1],"name":[1],"value":[1],"inputProps":[16],"disabled":[4],"autoCompleted":[32]}]);
...
const AmplifyUsernameField$1 = /*@__PURE__*/proxyCustomElement(AmplifyUsernameField, [0,"amplify-username-field",{"fieldId":[1,"field-id"],"label":[1],"placeholder":[1],"required":[4],"handleInputChange":[16],"value":[1],"inputProps":[16],"disabled":[4]}]);
