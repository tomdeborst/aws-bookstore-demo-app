...
const AmplifyEmailField = class {
    ...
    render() {
        return (index.h("amplify-form-field", { fieldId: this.fieldId, label: core.I18n.get(this.label), placeholder: core.I18n.get(this.placeholder), type: "email", name: "email", required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    }
};
...
const AmplifyUsernameField = class {
    ...
    render() {
        return (index.h("amplify-form-field", { name: "username", fieldId: this.fieldId, label: core.I18n.get(this.label), placeholder: core.I18n.get(this.placeholder), required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    }
};
